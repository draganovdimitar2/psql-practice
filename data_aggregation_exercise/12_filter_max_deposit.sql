...
Create a SQL query that retrieves the name of the "magic_wand_creator" and their maximum "deposit_amount" from the "wizard_deposits" table.
 The results should be grouped by the "magic_wand_creator" and filtered to only include those with a maximum "deposit_amount" that falls outside the range of 20000 to 40000. 
